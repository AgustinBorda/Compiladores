...
#line 57 "calc-sintaxis.y"
                  {
                    ...
                    if(assemble((yyvsp[0].n), symbol_table) == 0) {
                     printf("Ensamblado\n");
                    }
                      
                  }
#line 1380 "calc-sintaxis.tab.c"
    break;
